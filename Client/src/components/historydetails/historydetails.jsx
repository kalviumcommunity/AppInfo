        ...
        <div id="toc">
          <table id="tablebottompadding">
            <tr>
              ...
              <td id="tableborder">{props.historyDetails.application_Name}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td id="tableborder">{props.historyDetails.targetSdkVersion}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td id="tableborder">{props.historyDetails.supportScreensizes}</td>
            </tr>
            ...
            <tr>
              ...
              <td  id="tableborder"className="overflow">{props.historyDetails.features}</td>
            </tr>
            <tr>
              <td id="tableborder">Permissions</td>
              <td id="tableborder" className="overflow">{props.historyDetails.permissions}</td>
            </tr>

            <tr>
              <td id="tableborder">Languages</td>
              <td  id="tableborder"className="overflow">{props.historyDetails.languages}</td>
            </tr>

            <tr>
              <td id="tableborder">Signature</td>
              <td  id="tableborder"className="overflow">{props.historyDetails.signatures}</td>
            </tr>
          </table>
        </div>
      </div>
